...
function freq_em() {
  ...
  # $RELEASE -k 12 benchmark data/r1.fa data/d1.fa -V 10 --init-state zero --parallel freq-em > data/r1_f0_k12.freqem.tsv
  # $RELEASE -k 16 benchmark data/r1.fa data/d1.fa -V 10 --init-state zero --parallel freq-em > data/r1_f0_k16.freqem.tsv
  # $RELEASE -k 24 benchmark data/r1.fa data/d1.fa -V 10 --init-state zero --parallel freq-em > data/r1_f0_k24.freqem.tsv
  # $RELEASE -k 32 benchmark data/r1_k32_n30.fa data/d1.fa -V 10 --init-state zero --parallel freq-em > data/r1_k32_n30_f0_k32.freqem.tsv
  $RELEASE -k 32 benchmark data/r1_k32_n100.fa data/d1.fa -V 10 --init-state zero --parallel freq-em > data/r1_k32_n100_f0_k32.freqem.tsv
