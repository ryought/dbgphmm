...
then
  ...
  # ./target/release/infer -k 40 -K 1000 -p 0.00001 -e 0.001 -I 50 -s 500 --km 1000 --kr 1000 --dataset-json n3/p01_u20_n$N.json --output-prefix n3/e_p01_u20_n$N
  # ./target/release/infer -k 40 -K 1000 -p 0.0001 -e 0.001 -I 50 -s 500 --km 1000 --kr 1000 --dataset-json n3/p01_u20_n$N.json --output-prefix n3/p01_u20_n$N
